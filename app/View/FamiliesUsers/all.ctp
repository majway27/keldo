<div class="familiesUsers index">
	<h2><?php echo __('Families Users'); ?></h2>
	...
	<tr>
		<td><?php echo h($familiesUser['FamiliesUser']['id']); ?>&nbsp;</td>
		<td>
		...
		<td><?php echo h($familiesUser['FamiliesUser']['created']); ?>&nbsp;</td>
		<td><?php echo h($familiesUser['FamiliesUser']['modified']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $familiesUser['FamiliesUser']['id']), null, __('Are you sure you want to delete # %s?', $familiesUser['FamiliesUser']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
